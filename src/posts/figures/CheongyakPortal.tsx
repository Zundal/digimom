...
export default function CheongyakPortal() {
  const { t } = useTranslation();
  const reduced = usePrefersReducedMotion();
  const steps = t("figures.cheongyakPortal.steps", {
    returnObjects: true,
  }) as Step[];

  return (
    <Frame
      title={t("figures.cheongyakPortal.title")}
      caption={t("figures.cheongyakPortal.caption")}
      footer={t("figures.cheongyakPortal.note")}
    >
